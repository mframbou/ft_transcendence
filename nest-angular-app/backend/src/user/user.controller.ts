...
export class UserController {
    ...
    async two_factor_dectivation(@Param('id') idIntra: string, @Req() req) : Promise<any> {
        try {
            if (await this.permissionService.is_administrator(req) || await this.permissionService.is_current_user(req, idIntra)  ){
