...
var AuthService = /** @class */ (function () {
    function AuthService(jwt, prisma, cacheManager) {
        this.jwt = jwt;
        this.prisma = prisma;
        this.cacheManager = cacheManager;
    }
    AuthService.prototype.start_two_factor = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        otp = _a.sent();
                        if (!(otp.otpSecret === '')) return [3 /*break*/, 3];
    ...
    AuthService.prototype.completed_two_factor = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            var secret;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!secret.twoFa)
                            return [2 /*return*/];
                        return [4 /*yield*/, qrcode.toDataURL(secret.otpUrl)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    AuthService.prototype.check_two_factor = function (body, res) {
        return __awaiter(this, void 0, void 0, function () {
            var user, verified, jwt;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prisma.user.findUnique({
                            where: { id: body.id },
