...
You first need to create a `.env` file with the following:
...
# This is the hostname for the server, in the future it should be removed (can you still see me ? 👀)
# You should set this to either localhost (app will only work in local) or your computer hostname
HOST=your-computer-hostname
```
...
You can then access the app at the `SERVER_NAME` you defined in `.env` at port `3001`.
